  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        stuckWarning: {
          type: 'number',
          description: 'Seconds before stuck detection kills command (default: auto-adjusted, ~15s for fast commands, 45-75s for known slow commands like npm install/git clone). Output resets the timer — commands producing stdout/stderr won\'t be killed prematurely.',
        },
      },
      required: ['command'],
    },
